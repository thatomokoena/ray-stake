    ...
    <div className={style.faq}>
      ...
      <ul>
        ...
        <li>
          ...
          <Link to="/pools/">RayStake &rarr; Pools</Link> section)
        </li>
      </ul>
      <div className="ray__line" />
      <h5>
      ...
      <p>
        Go to the{" "}
        <Link href="/track/">RayStake &rarr; Track & Withdraw</Link>{" "}
      ...
      <p>
        ...
        <a href="https://rraayy.com/xray/distribution/" target="_blank" rel="noopener noreferrer">Homepage &rarr; XRAY &rarr; Distribution</a>.
      </p>
      <div className="ray__line" />
    </div>
  )
